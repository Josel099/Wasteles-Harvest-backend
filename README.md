...
This repository contains the back-end of our application, which is built using spring boot . To fully utilize the application, you need to set up the frond end of the project. You can find instructions for setting up the frond end by visiting the [backend repository](https://github.com/Josel099/Wasteles-Harvest-backend). 🚀
